...
if [[ -z $latest_net ]]; then
    ...
    $HOME/src/lc0/build/release/lc0 selfplay --syzygy-paths=/home/hans/syzygy --no-adjudicate --training --training --games=$number_of_games_per_net --parallelism=12 --visits=800 --backend=random --openings-pgn=$HOME/start.pgn --openings-mode=shuffled;
    i=1
else
