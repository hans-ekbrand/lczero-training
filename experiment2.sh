...
./inner_NPM_iterations.sh turbo3 /mnt          start-6-men.pgn 800        400  400  250   0.25  10 > ~/turbo2.log
...
./inner_NPM_iterations.sh turbo3 /mnt          start-6-men.pgn 800        16000  1200  250   0.25  25 >> ~/turbo2.log
