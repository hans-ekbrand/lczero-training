...
## sudo rm -rf ~/kb1-64x6-turbo/ ~/leelalogs/kb1-64x6-turbo-t*
## rm -rf ~/leela-nets/turbo/ ~/leela-training-games/turbo/ 
...
./single_run_train_in_docker_turbo.sh $1 $6
...
for i in {1..25}; do
    ./single_run_train_in_docker_turbo.sh $1 ${10}        
done
