...
## sudo rm -rf ~/kb1-64x6-without_tb ~/leela-nets/without_tb ~/leela-training-games/without_tb ~/without_tb.log ~/leelalogs/kb1-64x6-without_tb-train ~/leelalogs/kb1-64x6-without_tb-test
...
if [[ -z $latest_net ]]; then
    ...
    $HOME/src/lc0/build/release/lc0 selfplay --training --training --games=$number_of_games_per_net --parallelism=12 --visits=800 --backend=random
    i=1
else
