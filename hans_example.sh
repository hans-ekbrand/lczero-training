...
HOME=$HOME/leela-training-games/${variant}
...
net_dir=$REAL_HOME/leela-nets/${variant}
mkdir -p $net_dir
...
until false # run this loop until further notice
  ...
  python3 $REAL_HOME/src/lczero-training/tf/train.py --cfg $REAL_HOME/src/lczero-training/tf/configs/${variant}.yaml --output $REAL_HOME/leela-nets/${variant}/${i}.gz;
